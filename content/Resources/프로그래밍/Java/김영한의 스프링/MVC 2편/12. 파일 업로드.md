...
```
request=org.springframework.web.multipart.support.StandardMultipartHttpServletRequest@3199ada
itemName=spring
parts=[org.apache.catalina.core.ApplicationPart@dde64c9, org.apache.catalina.core.ApplicationPart@9e1f1aa]
=== PART ===
name = itemName
...
=== PART ===
name = file
header content-disposition = form-data; name="file"; filename="교토01.jpg"
header content-type = image/jpeg
submittedFilename = 교토01.jpg
size = 261193
body = �����JFIF��`�`���FExif��MM�*���
