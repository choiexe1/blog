...
이론적으로는 모든 객체에 인터페이스를 도입해서 역할과 구현을 나누는 것이 좋다. 이렇게 하면 역할과 구현을 나누어서 구현체를 매우 편리하게 변경할 수 있다. 하

---
References: 김영한의 스프링 핵심 원리 - 고급편

Links to this page: [[Resources/프로그래밍/Java/김영한의 자바/기본/다형성|다형성]], [[상속과 메서드 오버라이딩]]