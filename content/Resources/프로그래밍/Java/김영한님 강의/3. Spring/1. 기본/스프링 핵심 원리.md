...
앞서 학습했던 [[Resources/프로그래밍/Java/김영한님 강의/0. 기본/다형성|다형성]]을 활용하여 객체 지향 설계 방법으로 개발한다. 먼저 스프링 없는 순수한 자바로만 개발을 진행한다.
...
Links to this page: [[Resources/프로그래밍/Java/김영한님 강의/0. 기본/다형성|다형성]], [[스프링 컨테이너와 스프링 빈]]
