...
[[Resources/프로그래밍/Java/김영한의 자바/0. 기본/다형성#다형적 참조|다형적 참조]]를 통해 `ChronoField`를 입력 받고, 만약 인자가 `ChronoField`라면 해당 `Enum`에 구현되어 있는 메서드를 사용하여 결과를 반환한다.
...
Links to this page: [[날짜와 시간 1]], [[Resources/프로그래밍/Java/김영한의 자바/0. 기본/다형성|다형성]], [[포매팅]], [[파싱]], [[날짜와 시간 복습]]