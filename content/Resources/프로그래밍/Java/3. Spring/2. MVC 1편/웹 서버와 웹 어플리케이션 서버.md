...
Client2 -->|여유 쓰레드가 없음, 대기| Connection
...
Client1 --> |HTTP 요청| Connection -.-> |쓰레드 할당 요청| ThreadPool --> |쓰레드 할당| Thread1 --> |서블릿 객체 호출| Servlet
Client2 --> |HTTP 요청| Connection -.-> |쓰레드 할당 요청| ThreadPool --> |쓰레드 할당| Thread2 --> |서블릿 객체 호출| Servlet
```
