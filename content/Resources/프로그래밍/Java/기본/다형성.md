...
### 다형성과 캐스팅
[[Resources/Programming/Java/기본/다형성#다형적 참조]]의 예시 코드처럼 작성하면, 부모 타입의 변수가 자식 인스턴스의 기능을 호출할 수 없다.
...
Links: [[Resources/Programming/Java/기본/객체 지향 프로그래밍]] [[Resources/Programming/Java/기본/캡슐화]]
