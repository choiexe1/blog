...
- 펀익스 (Junior Backend Engineer, Node.js)

한국으로 돌아와서는 자바스크립트 런타임인 Node.js를 통해 백엔드 프로그래밍에 입문하여 5명으로 이루어진 작은 개발팀에서 주니어 백엔드 개발자로 일 하였고, 아무래도 규모가 작다보니 다양한 경험들을 할

>CentOS 기반 서버에서 쉘 스크립트로 서버 배포 자동화
>파이썬을 통한 업무 자동화 (대부분 엑셀 및 웹 업무 자동화)
...
- 2024
현재는 Java 공부에 집중하고 있어, 주로 Java 관련된 컨텐츠를 작성하고 있습니다.
