...
function isIndexFile(path) {
  ...
  if (pathParts[0] == FolderIndexPlugin.PLUGIN.settings.rootIndexFile) return true
...
function isExcludedPath(path) {
  for (const excludedFolder of FolderIndexPlugin.PLUGIN.settings.excludeFolders) {
    ...
    if (RegExp(`^${excludedFolder}$`).test(path)) return true
  }
  return false
}
...
var PluginSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .setDesc(
        "This will overwrite the default graph view and link files based on their index as well as their normal links",
      )
      .addToggle((component) =>
        component.setValue(this.plugin.settings.graphOverwrite).onChange((value) =>
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addText((component) =>
        component
          .setValue(this.plugin.settings.rootIndexFile)
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.autoCreateIndexFile).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.autoRenameIndexFile).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.indexFileUserSpecified).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .setDesc(
        "This will hide IndexFiles from the file explorer (Disabled as it causes bugs right now)",
      )
      .addToggle((component) =>
        component
          .setValue(this.plugin.settings.hideIndexFiles)
          .onChange((value) =>
            __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.includeFileContent).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.disableHeadlines).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addText((component) =>
        component
          .setValue(this.plugin.settings.headlineLimit.toString())
          .setPlaceholder("6")
          .onChange((value) =>
            __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.autoPreviewMode).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addDropdown((component) => {
        ...
        component.setValue(this.plugin.settings.sortIndexFiles).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addDropdown((component) => {
        ...
        component.setValue(this.plugin.settings.sortHeaders).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.recursiveIndexFiles).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addText((component) =>
        component
          .setValue(this.plugin.settings.recursionLimit.toString())
          .setPlaceholder("-1")
          .onChange((value) =>
            __async(this, null, function* () {
              let numValue = Number.parseInt(value)
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.renderFolderBold).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.renderFolderItalic).onChange((value) =>
          __async(this, null, function* () {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.useBulletPoints).onChange((value) =>
          __async(this, null, function* () {
...
var MarkdownTextRenderer = class {
  ...
  buildStructureMarkdownText(fileTree, indentLevel) {
    ...
    for (const file of fileTree) {
      ...
      if (file instanceof import_obsidian2.TFolder && this.plugin.settings.recursiveIndexFiles) {
        ...
        if (
          this.plugin.settings.recursionLimit === -1 ||
          indentLevel < this.plugin.settings.recursionLimit
        ) {
          markdownText += this.buildStructureMarkdownText(
            this.buildFileTree(children),
            indentLevel + 1,
          )
        }
      }
  ...
  buildContentMarkdownText(file, indentLevel, isFolder = false) {
    ...
    markdownText += this.buildMarkdownLinkString(
      this.getTitleFromPath(file.path),
      encodeURI(file.path),
      indentLevel,
      isFolder,
    )
    const headers =
      (_b = (_a = this.app.metadataCache.getFileCache(file)) == null ? void 0 : _a.headings) != null
        ? _b
        : []
  ...
  buildHeaderMarkdownText(file, headerTree, indentLevel, headlineLevel) {
    ...
    for (const headerWrapper of headerTree) {
      ...
      if (headlineLevel < this.plugin.settings.headlineLimit) {
        markdownText += this.buildHeaderMarkdownText(
          file,
...
`
  ...
  getTitleFromPath(path) {
    ...
    if (file instanceof import_obsidian2.TFile) {
      ...
      if (cache) {
        return (_b = (_a = cache.frontmatter) == null ? void 0 : _a.title) != null
          ? _b
          : file.basename
      }
    ...
    return __async(this, null, function* () {
      ...
      if (folder instanceof import_obsidian3.TFile) {
        ...
        yield import_obsidian3.MarkdownRenderer.renderMarkdown(
          renderer.buildMarkdownText(files),
          this.container,
          this.filePath,
          this,
        )
...
var GraphManipulatorModule = class {
      ...
      if (engine.oldRender == null) {
        ...
        engine.render = () => {
          if (this.plugin.settings.graphOverwrite) {
            ...
            if (engine.oldRender) engine.oldRender()
          }
        }
        if (this.plugin.settings.graphOverwrite) {
  ...
  render(engine) {
    ...
    this.app.vault.getFiles().forEach((file) =>
      __async(this, null, function* () {
        ...
        const cache = this.app.metadataCache.getFileCache(file)
        if (
          ((_a = file.parent) == null ? void 0 : _a.name) + ".md" == file.name ||
          file.name == this.plugin.settings.rootIndexFile
        ) {
          ;(_b = file.parent) == null
            ? void 0
            : _b.children.forEach((otherFile) => {
                ...
                if (otherFile instanceof import_obsidian4.TFolder) {
                  const subIndex = otherFile.children.find(
                    (value) => value.name == otherFile.name + ".md",
                  )
                  if (subIndex != null) {
        ...
        if (
          ...
          ((_c = this.app.workspace.getActiveFile()) == null ? void 0 : _c.path) == file.path
        ) {
          type = "focused"
    ...
    function AddColorTag(filePath, nodeType) {
      ...
      return (
        !searchQueries ||
        (nodeType === ""
          ? filePath === engineOptions.localFile ||
            (fileFilter.hasOwnProperty(filePath) ? fileFilter[filePath] : !engine.hasFilter)
          : nodeType === "tag"
            ? searchQueries.every(function (e) {
  ...
  clearAllGraphs() {
    this.graphsLeafs.forEach((value) =>
      this.getEngine(value).renderer.setData({
        nodes: {},
      }),
    )
  }
...
var FolderNoteModule = class {
  ...
  getTargetFromEvent(event) {
    ...
    if (activePlugins.has("file-tree-alternative")) {
      if (target.classList.contains("oz-folder-name")) {
        return (_c =
          (_b = (_a = target.parentElement) == null ? void 0 : _a.parentElement) == null
            ? void 0
      ...
      if (target.classList.contains("oz-folder-block")) {
        return (_e = (_d = target.parentElement) == null ? void 0 : _d.parentElement) != null
          ? _e
          : null
      }
    }
    if (target.classList.contains("nav-folder-title")) return target
    ...
    return __async(this, null, function* () {
      ...
      if (this.plugin.settings.autoCreateIndexFile) {
        ...
        try {
          ...
          const file = yield this.app.vault.create(
            path,
            this.plugin.settings.indexFileInitText.replace("{{folder}}", name),
          )
  ...
  onRename(file, oldPath) {
    return __async(this, null, function* () {
      ...
      if (!this.doesFileExist(`${oldPath}/${oldIndexFileName}.md`)) return
      const oldIndexFile = this.app.vault.getAbstractFileByPath(`${oldPath}/${oldIndexFileName}.md`)
      if (!isIndexFile(oldIndexFile.path)) return
      ...
      try {
        ...
        new import_obsidian5.Notice(
          `Failed to rename index file ${oldIndexFileName} to ${file.name}. ${file.name} will be used as the index file.`,
        )
      }
    })
  }
  onLayoutChange() {
    return __async(this, null, function* () {
      ...
      try {
        ...
        if (currentState.state.file == this.previousState.state.file) return
        ...
        if (currentState.type == "markdown") this.previousState = currentLeaf.getViewState()
      }
    })
  }
  onCreate(file) {
    ...
    return __async(this, null, function* () {
      ...
      try {
        const newFile = yield this.app.vault.create(
          indexFileForFolder,
          this.plugin.settings.indexFileInitText.replace(
            "{{folder}}",
            this.getIndexFileForFolder(indexFileForFolder),
          ),
        )
        new import_obsidian6.Notice(
          `File "${newFile.name}" created successfully in folder "${newFile.path}".`,
        )
  ...
  onSettingsUpdate() {
    if (this.settings.graphOverwrite != this.oldGraphSetting) {
      if (this.settings.graphOverwrite) {
        ...
        if (this.graphManipulator) this.graphManipulator.unload()
      }
      this.oldGraphSetting = this.settings.graphOverwrite
    }
  }
