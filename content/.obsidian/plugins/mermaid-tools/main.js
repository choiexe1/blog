...
var MermaidElementService = class {
  ...
  fixSortOrder(element, plugin) {
    ...
    if (
      elementsFromSameCategory.some((element2) => element2.sortingOrder === element2.sortingOrder)
    ) {
...
`
  ...
  wrapAsCompleteDiagram(element) {
    ...
    const content =
      element.category === "Mindmap" /* Mindmap */
        ? element.content
        : this.withTitle(element.description, element.content)
    return (
      wrapping.wrappings
...
var EditMermaidElementModal = class extends import_obsidian2.Modal {
  ...
  async onOpen() {
    ...
    if (!this._mermaid) this._mermaid = await (0, import_obsidian2.loadMermaid)()
...
function createTopRowBtns(parentEl, buttons) {
  buttons.forEach((btn) => {
    let b = new import_obsidian4.ButtonComponent(parentEl)
...
var _MermaidToolbarView = class extends import_obsidian5.ItemView {
  constructor(leaf, plugin) {
    super(leaf)
    this.topRowButtons = [
      new MermaidToolbarButton("insert Mermaid code block with sample diagram", "code-2", () =>
      ...
      new MermaidToolbarButton("open Mermaid.js documentation web page", "external-link", () =>
...
var MermaidPlugin = class extends import_obsidian6.Plugin {
  ...
  async onload() {
    ...
    this.app.workspace.on("active-leaf-change", (leaf) => {
      var _a, _b
      this.activeEditor =
        (_b = (_a = this.app.workspace.activeEditor) == null ? void 0 : _a.editor) != null
          ? _b
          : this.activeEditor
    })
